  ...
  useEffect(() => {
    if (status === "authenticated" && session) {
      ...
      if (userRole === "admin") {
        ...
        setGeneralError("คุณไม่มีสิทธิ์เข้าถึงหน้านี้");
        signOut(); // ออกจากระบบทันที
      }
    }
    ...
    >
      <div className="w-full md:w-1/2 flex flex-col justify-center p-8 bg-white">
        <div className="max-w-md mx-auto w-full">
          <h2 className="text-5xl font-bold text-gray-900 mb-6">เข้าสู่ระบบ</h2>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  } rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-lg`}
                />
                {errors.email && (
