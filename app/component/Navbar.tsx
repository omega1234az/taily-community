    ...
    <div className="relative h-screen">
      ...
      <div className="fixed top-0 left-0 h-full w-64 z-40">
        <div className="relative flex flex-col items-center h-full sm:w-40 md:w-52 xl:w-64 bg-gradient-to-b p-6">
          ...
          {/* เนื้อหา */}
          <div className="flex flex-col sm:items-center z-10 w-full mt-20 ">
            <img
              src="/all/owen.png"
              alt="Profile"
              className="sm:w-24  w-14 xl:w-36 h-auto rounded-full object-cover border-4 border-white mb-2"
            />
