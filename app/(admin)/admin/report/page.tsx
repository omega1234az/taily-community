      ...
      try {
        ...
        const formatted: Report[] = data.map((r: any) => ({
          ...
          post: {
            ...
            pet: r.post?.pet
              ? {
                  name: r.post.pet.name || "Unknown",
                  images: r.post.pet.images || [],
                }
              : undefined,
      ...
      {selectedReport && (
        <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-8 max-w-4xl w-full border shadow-2xl overflow-auto max-h-[90vh] relative">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    <strong>ชื่อ:</strong> {selectedReport.name}
                  </p>
                  <p className="text-sm text-gray-600">
                    <strong>อีเมล:</strong> {selectedReport.email}
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-700 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    <strong>เหตุผล:</strong> {selectedReport.report}
                  </p>
                </div>
              </div>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    {selectedReport.post.type === "lostpet"
                      ? "สัตว์หาย"
                      : "หาเจ้าของ"}
                  </p>
                  {selectedReport.post.pet && (
                    <p className="text-sm text-gray-600">
                      <strong>ชื่อสัตว์:</strong> {selectedReport.post.pet.name}
                    </p>
                  )}
                  <p className="text-sm text-gray-600">
            ...
            {/* Images */}
            {selectedReport.post.pet?.images?.length ||
            selectedReport.post.images?.length ? (
              <div className="mb-6">
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M15 12H9m12 0a9 9 0 11-18.18-5.18M15 12a2.5 2.5 0 01-5 0m0 0a2.5 2.5 0 015 0m6.36-.86l-1.5-1.5"
                  />
                </svg>
                ลบโพสต์
              </button>
