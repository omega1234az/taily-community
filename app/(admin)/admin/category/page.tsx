...
export default function Categories() {
  ...
  const handleSave = async () => {
    if (editingIndex !== null) {
      ...
      try {
        ...
        updatedCategories[indexOfFirstCategory + editingIndex].name = editedName.trim();
  ...
  if (!categories.length) return <div className="text-center py-8 text-gray-600">ไม่มีประเภทสัตว์เลี้ยง</div>;

  return (
    <div className="w-full max-w-7xl mx-auto p-6 bg-white rounded-2xl shadow-xl">
      <h1 className="text-3xl font-bold text-gray-800 mb-8 text-center">จัดการประเภทสัตว์เลี้ยง</h1>

      {/* Summary Section */}
      <div className="mb-10">
        <h2 className="text-xl font-semibold text-gray-700 mb-4">สรุปประเภทสัตว์เลี้ยง</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-blue-50 p-6 rounded-xl shadow-md flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-blue-600 text-lg">ประเภททั้งหมด</h3>
      ...
      {/* Table Section */}
      <div className="mb-10">
        <h2 className="text-xl font-semibold text-gray-700 mb-4">รายการประเภทสัตว์เลี้ยง</h2>
        ...
        <div className="fixed inset-0  bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl relative">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-semibold text-gray-800">เพิ่มประเภทสัตว์เลี้ยง</h2>
              <button
                onClick={() => {
                  setShowAddBox(false);
                  setNewCategoryName("");
