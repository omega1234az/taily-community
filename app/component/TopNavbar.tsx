...
export default function TopNavbar() {
  ...
  return (
    <div className="sticky top-5 sm:top-5 lg:top-6 2xl:top-7 left-0 right-0 z-50 bg-white px-4 py-2 mx-6 flex justify-between items-center shadow-md rounded-lg">
      ...
      <div className="flex gap-6 font-medium sm:gap-12 lg:gap-28 xl:gap-42 items-center relative sm:text-lg lg:text-xl 2xl:text-2xl">
        ...
        >
          <h1 className={`${isHovered ? 'text-sky-600' : ''}`}>
            ประกาศ
          </h1>
          <span className={`transition-colors ${isHovered ? 'text-sky-600' : 'text-gray-600'}`}>
            <svg 
              ...
              className="w-2.5 h-2.5 sm:w-3 sm:h-3  xl:w-3.5 xl:h-3.5 2xl:w-4 2xl:h-4"
            >
              <path 
  ...
  <img
    src="/all/bell.svg"
    alt="bell"
    className="lg:w-12 lg:h-12 xl:w-14 xl:h-14 w-8 h-8 sm:w-11 sm:h-11 md:w-12 md:h-12 p-1 rounded-full object-cover cursor-pointer text-gray-600 hover:text-white bg-[#7CBBEB] hover:bg-sky-600 "
  />
</div>
