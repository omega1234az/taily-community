      ...
      <div className="flex flex-col justify-between  w-full ">
        ...
        <div className="flex justify-center mt-3 text-center md:text-left">
          <button
            ...
            className="rounded-xl shadow-md bg-[#EAD64D] text-black text-[10px] sm:text-sm  sm:px-6 sm:py-2 px-3 py-1.5 hover:bg-yellow-200 transition duration-300 cursor-pointer"
          >
            รายละเอียด
          </button>
        </div>
